...
""" # %% [code] {"execution":{"iopub.status.busy":"2025-01-03T19:48:27.416706Z","iopub.execute_input":"2025-01-03T19:48:27.417102Z","iopub.status.idle":"2025-01-03T19:48:27.932731Z","shell.execute_reply.started":"2025-01-03T19:48:27.417072Z","shell.execute_reply":"2025-01-03T19:48:27.931721Z"}}
# List all unique team abbreviations in the 2003-04 season
teams_2003_04 = new_table[new_table['season'] == '2003-04'][['team_abbreviation_home', 'team_abbreviation_away']]
teams_2003_04_unique = pd.concat([teams_2003_04['team_abbreviation_home'], teams_2003_04['team_abbreviation_away']]).unique()

# Print the list of unique teams
print(teams_2003_04_unique)
 """
